...
Copy the entire `src/app/cards/` directory from this project into your app's `src/app/` directory. If your app already has cards, you may need to merge files rather than overwrite the whole folder.
...
Each card in your app must have a unique `uid`. The converter cards use these uids by default:
