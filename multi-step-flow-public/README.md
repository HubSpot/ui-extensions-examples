...
### Step 4: Install the OAuth app in your test account

After uploading, open the app in your developer account and use its app ID, client ID, and scopes to install it in your test account. You can use the [OAuth Node.js quickstart](https://github.com/hubspot/oauth-quickstart-nodejs) to complete the installation flow.

### Step 5: View the cards in the dev test account
...
- [MenuPanelContent.tsx](src/app/cards/components/MenuPanelContent.tsx) displays the selected restaurant menu in a panel.
